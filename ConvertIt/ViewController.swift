...
//  ConvertIt
//
//  Created by Jess Newman on 3/11/18.
...
//            outputValue = inputValue * 1.05669
//        default:
//            showAlert(title: "Unexpected Error", message: "Contact the developed and share that \"\(conversionString)\" could not be indentified.")
//        }
